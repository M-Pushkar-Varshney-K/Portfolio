...
export default function Header() {
  ...
  return (
    <header className="z-[999] relative">
      ...
      <nav className="flex fixed top-0 left-1/2 h-[4.5rem] sm:h-[3.25rem] -translate-x-1/2 items-center sm:top-6">
        <ul className="flex sm:w-[44rem] w-full justify-center items-center gap-4 text-[0.9rem] font-medium text-gray-500 px-4">
          {links.map((link) => (
            <motion.li
              className="relative"
              key={link.hash}
